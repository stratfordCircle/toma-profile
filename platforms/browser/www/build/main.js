...
TabsPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\~y\~ionic\pomo-profile\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"C:\~y\~ionic\pomo-profile\src\pages\tabs\tabs.html"*/
    }),
...
AboutPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-about',template:/*ion-inline-start:"C:\~y\~ionic\pomo-profile\src\pages\about\about.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      About\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <ion-buttons text-center>\n    <!-- {{ this.date }} -->\n    <button clear style="background-color:#f6f7f8" icon-left (click)="showDatePicker()">\n      <ion-icon name="calendar">\n      </ion-icon>\n    </button>\n</ion-buttons>\n\n\n</ion-content>'/*ion-inline-end:"C:\~y\~ionic\pomo-profile\src\pages\about\about.html"*/
    }),
...
//import { URL } from '@angular/url-parse';
//@IonicPage()
var ContactPage = (function () {
    ...
    ContactPage.prototype.ionViewDidLoad = function () {
        ...
        this.storage.get('groovyKey').then(function (val) {
            ...
            //skenney - 1003682710
            //fun - 1003890650
            //configuring for remote hosting on firebase
            //this.http.get('http://localhost:8100/api/v1/profile/me', options)
            ...
            pomaHeaders.set('GET', '/api/v1/profile/me HTTP/1.1');
            pomaHeaders.append('Accept', 'application/json');
            ...
            _this.http.get('http://localhost:8100/api/v1/profile/me', options)
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                var myResponse = JSON.stringify(data);
                // WITHOUT THE STRINGIFY ABOVE, WE JUST GET [OBJECT OBJECT]
                console.log('myRes ' + myResponse);
                var firstName = myResponse.split('First]":"')[1];
                firstName = firstName.substring(0, firstName.indexOf('","'));
                //alert('|'+firstName+'|');
                var lastName = myResponse.split('Last]":"')[1];
                lastName = lastName.substring(0, lastName.indexOf('","'));
                //alert('|'+lastName+'|');
                var suffix = myResponse.split('Suffix]":"')[1];
                suffix = suffix.substring(0, suffix.indexOf('","'));
                //alert('|'+suffix+'|');
                var member_type = myResponse.split('Member Type]":"')[1];
                member_type = member_type.substring(0, member_type.indexOf('","'));
                alert('member type |' + member_type + '|');
                if (suffix == 'D.O.') {
...
ContactPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-contact',template:/*ion-inline-start:"C:\~y\~ionic\pomo-profile\src\pages\contact\contact.html"*/'<html>\n  <head>\n    <meta charset="utf-8" />\n    <meta http-equiv="Access-Control-Allow-Origin" content="*">\n  </head>\n</html>  \n\n<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-start></ion-icon>\n      {{ this.greeting }}\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\~y\~ionic\pomo-profile\src\pages\contact\contact.html"*/
    }),
...
MyApp = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({template:/*ion-inline-start:"C:\~y\~ionic\pomo-profile\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"C:\~y\~ionic\pomo-profile\src\app\app.html"*/
    }),
